...
There is a small issue with the stuttering of the cubes when moving. This is likely due to some objects using physics being updated inside the FixedUpdate() method, and other non-physics objects using the Update() method (which updates more frequently than the former).
